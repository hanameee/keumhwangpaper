...
const Home = (props) => {
    ...
    const modalClickHandler = (visibleState, image) => {
        setModalState({ isVisible: visibleState, visibleImage: image });
    };
    return (
        <>
            <Layout bodyClass="page-home">
                ...
                <div className="intro">
                    <div className="container">
                        ...
                        <p>
                            한지 (hanji, traditional Korean paper made from
                    ...
                    <div className="row justify-content-start">
                        ...
                        <div className="CarouselWrapper">
                            <div className="col-12 col-md-9 CarouselText">
                                저희 금황한지산업은 1985년 ‘금황특수제지’에서
                                시작해 1988년부터 기계한지 제조회사로 전환 증설
                                후 지금까지 30여년이 넘는 세월 동안 오직{" "}
                                ...
                                항균기능과 탈취기능을 상당부분 개선한
                                한지제품으로, 자사 기능성 원료인
                                한지추출물(검은황토)를 한지에 혼합하여 기계화된
                                한지 설비로 대량생산 한 것으로서 항균, 탈취 등이
                                필요한 필터 등{" "}
                                <span className="pointColor">
                                    설비의 핵심재료로 활용이 가능한 첨단소재
                                    한지
                                </span>
                                입니다.
                                <br />
                                <br /> 이렇듯 금황한지산업은 전통 한지와는
                                차별화된 기능 중심의 고기능성 한지를 통하여{" "}
                                <span className="pointColor">
                                    한지의 첨단화 및 세계화
                                </span>
                                를 목표로 하고 있습니다.
