                ...
                <div className="storiesContainer mt-4">
                    <div className="story mb-2">
                        ...
                        <div className="storyContent">
                            ...
                            독이 없는 약재로 한방에서는 열매를 양기부족,
                            수종(몸이 붓는 부종)의 치료제로 썼으며 닥나무
                            어린잎은 식용으로 사용하였다.
                        </div>
                    ...
                    <div class="story mb-2">
                        ...
                        <div className="storyContent">
                            ...
                            전주시는 한국한의학연구원과 전주생물소재연구소에
                            맡겨 닥나무의 효능을 분석한 결과 닥나무 잎과 속대의
                            추출물 등이 아토피성 피부염의 원인 물질이 활성화하는
                            것을 막고 면역력을 높이는 것으로 나타났다고 19일
                            밝혔다. 아토피성 피부염으로 인한 부종이나 출혈, 피부
                            각질화를 억제하는 효과도 냈다. 이와 함께 닥나무를 찐
                            물은 각종 세포를 증식 또는 활성화하는 데 관여해
                            아토피성 피부염에 대한 면역력을 높이는 기능을 하는
                            것으로 분석됐다. (연합뉴스)
                            <h3 className="storySubTitle">기계 한지 이야기:</h3>
                            한지산업은 1957년 전북도에만 315개에 이르고
                            종사자수가 4978명에 이르렀으나, 1977년 한지 제조소와
                            농가는 약 160호로 감소하였으며, 2006년 문화관광부
                            한지문화산업 자원실태조사 보고서에 따르면 전국의
                            수제 및 기계한지 제조업체는 30여개로 크게
                            축소되었으며, 현재 한지를 산업에 응용할 수 있는
                            생산기반을 가진 업체는 금황한지산업을 비롯한 전국
                            3개업체만 존재한다.
                            ...
                            한지설비로 대량생산한 것으로 항균, 탈취 등이 필요한
                            필터 등 설비의 핵심재료로 활용이 가능한 첨단소재
                            한지
                        </div>
                    </div>
                </div>
